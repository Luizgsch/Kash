...
import com.kash.di.DatabaseModule_ProvideInsightsDaoFactory;
import com.kash.di.DatabaseModule_ProvideLossDaoFactory;
import com.kash.di.DatabaseModule_ProvideProductDaoFactory;
import com.kash.di.DatabaseModule_ProvideProductTransactionDaoFactory;
import com.kash.di.DatabaseModule_ProvideSaleDaoFactory;
...
import com.kash.presentation.history.HistoryViewModel;
import com.kash.presentation.history.HistoryViewModel_HiltModules;
import com.kash.presentation.insights.InsightsViewModel;
import com.kash.presentation.insights.InsightsViewModel_HiltModules;
import com.kash.presentation.loss.LossViewModel;
import com.kash.presentation.loss.LossViewModel_HiltModules;
import com.kash.presentation.product.ProductViewModel;
import com.kash.presentation.product.ProductViewModel_HiltModules;
import com.kash.presentation.transaction.TransactionViewModel;
...
public final class DaggerKashApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends KashApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(8).put(LazyClassKeyProvider.com_kash_presentation_AppViewModel, AppViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kash_presentation_dashboard_DashboardViewModel, DashboardViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kash_presentation_history_HistoryViewModel, HistoryViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kash_presentation_insights_InsightsViewModel, InsightsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kash_presentation_auth_LoginViewModel, LoginViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kash_presentation_loss_LossViewModel, LossViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kash_presentation_product_ProductViewModel, ProductViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kash_presentation_transaction_TransactionViewModel, TransactionViewModel_HiltModules.KeyModule.provide()).build());
    }
    ...
    private static final class LazyClassKeyProvider {
      ...
      static String com_kash_presentation_insights_InsightsViewModel = "com.kash.presentation.insights.InsightsViewModel";

      static String com_kash_presentation_transaction_TransactionViewModel = "com.kash.presentation.transaction.TransactionViewModel";

      static String com_kash_presentation_product_ProductViewModel = "com.kash.presentation.product.ProductViewModel";

      static String com_kash_presentation_history_HistoryViewModel = "com.kash.presentation.history.HistoryViewModel";
      ...
      static String com_kash_presentation_loss_LossViewModel = "com.kash.presentation.loss.LossViewModel";

      @KeepFieldType
      DashboardViewModel com_kash_presentation_dashboard_DashboardViewModel2;

      @KeepFieldType
      InsightsViewModel com_kash_presentation_insights_InsightsViewModel2;

      @KeepFieldType
      TransactionViewModel com_kash_presentation_transaction_TransactionViewModel2;

      @KeepFieldType
      ProductViewModel com_kash_presentation_product_ProductViewModel2;

      @KeepFieldType
      HistoryViewModel com_kash_presentation_history_HistoryViewModel2;
      ...
      @KeepFieldType
      LossViewModel com_kash_presentation_loss_LossViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends KashApplication_HiltComponents.ViewModelC {
    ...
    private Provider<LossViewModel> lossViewModelProvider;
    ...
    private GetProfitabilityInsightsUseCase getProfitabilityInsightsUseCase() {
      return new GetProfitabilityInsightsUseCase(singletonCImpl.bindInsightsRepoProvider.get());
    }
    ...
    private AddSaleUseCase addSaleUseCase() {
      return new AddSaleUseCase(singletonCImpl.bindTransactionRepoProvider.get(), singletonCImpl.bindProductRepoProvider.get());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.lossViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 5);
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(8).put(LazyClassKeyProvider.com_kash_presentation_AppViewModel, ((Provider) appViewModelProvider)).put(LazyClassKeyProvider.com_kash_presentation_dashboard_DashboardViewModel, ((Provider) dashboardViewModelProvider)).put(LazyClassKeyProvider.com_kash_presentation_history_HistoryViewModel, ((Provider) historyViewModelProvider)).put(LazyClassKeyProvider.com_kash_presentation_insights_InsightsViewModel, ((Provider) insightsViewModelProvider)).put(LazyClassKeyProvider.com_kash_presentation_auth_LoginViewModel, ((Provider) loginViewModelProvider)).put(LazyClassKeyProvider.com_kash_presentation_loss_LossViewModel, ((Provider) lossViewModelProvider)).put(LazyClassKeyProvider.com_kash_presentation_product_ProductViewModel, ((Provider) productViewModelProvider)).put(LazyClassKeyProvider.com_kash_presentation_transaction_TransactionViewModel, ((Provider) transactionViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.kash.presentation.AppViewModel 
          return (T) new AppViewModel(singletonCImpl.bindAuthRepoProvider.get());

          case 1: // com.kash.presentation.dashboard.DashboardViewModel 
          return (T) new DashboardViewModel(singletonCImpl.bindDailyProfitRepoProvider.get(), singletonCImpl.bindProductRepoProvider.get(), singletonCImpl.userPreferencesProvider.get());

          case 2: // com.kash.presentation.history.HistoryViewModel 
          return (T) new HistoryViewModel(singletonCImpl.bindDailyProfitRepoProvider.get(), singletonCImpl.userPreferencesProvider.get());

          case 3: // com.kash.presentation.insights.InsightsViewModel 
          return (T) new InsightsViewModel(viewModelCImpl.getProfitabilityInsightsUseCase(), singletonCImpl.userPreferencesProvider.get());

          case 4: // com.kash.presentation.auth.LoginViewModel 
          return (T) new LoginViewModel(viewModelCImpl.loginUseCase());

          case 5: // com.kash.presentation.loss.LossViewModel 
          return (T) new LossViewModel(singletonCImpl.bindDailyProfitRepoProvider.get(), singletonCImpl.bindProductRepoProvider.get(), singletonCImpl.userPreferencesProvider.get());

          case 6: // com.kash.presentation.product.ProductViewModel 
          return (T) new ProductViewModel(singletonCImpl.bindProductRepoProvider.get(), singletonCImpl.userPreferencesProvider.get());

          case 7: // com.kash.presentation.transaction.TransactionViewModel 
          return (T) new TransactionViewModel(singletonCImpl.bindProductRepoProvider.get(), singletonCImpl.bindDailyProfitRepoProvider.get(), viewModelCImpl.addSaleUseCase(), singletonCImpl.userPreferencesProvider.get());
  ...
  private static final class SingletonCImpl extends KashApplication_HiltComponents.SingletonC {
    ...
    private Provider<DailyProfitRepositoryImpl> dailyProfitRepositoryImplProvider;

    private Provider<DailyProfitRepository> bindDailyProfitRepoProvider;

    private Provider<ProductRepositoryImpl> productRepositoryImplProvider;

    private Provider<ProductRepository> bindProductRepoProvider;

    private Provider<InsightsRepositoryImpl> insightsRepositoryImplProvider;

    private Provider<InsightsRepository> bindInsightsRepoProvider;

    private Provider<TransactionRepositoryImpl> transactionRepositoryImplProvider;

    private Provider<TransactionRepository> bindTransactionRepoProvider;
    ...
    private LossDao lossDao() {
      return DatabaseModule_ProvideLossDaoFactory.provideLossDao(provideDatabaseProvider.get());
    }
    ...
    private ProductTransactionDao productTransactionDao() {
      return DatabaseModule_ProvideProductTransactionDaoFactory.provideProductTransactionDao(provideDatabaseProvider.get());
    }

    private InsightsDao insightsDao() {
      return DatabaseModule_ProvideInsightsDaoFactory.provideInsightsDao(provideDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.dailyProfitRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 7);
      this.bindDailyProfitRepoProvider = DoubleCheck.provider((Provider) dailyProfitRepositoryImplProvider);
      this.productRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 8);
      this.bindProductRepoProvider = DoubleCheck.provider((Provider) productRepositoryImplProvider);
      this.insightsRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 9);
      this.bindInsightsRepoProvider = DoubleCheck.provider((Provider) insightsRepositoryImplProvider);
      this.transactionRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 10);
      this.bindTransactionRepoProvider = DoubleCheck.provider((Provider) transactionRepositoryImplProvider);
    }
        ...
        switch (id) {
          ...
          return (T) new SyncWorker_AssistedFactory() {
            ...
            public SyncWorker create(Context ctx, WorkerParameters params) {
              return new SyncWorker(ctx, params, singletonCImpl.transactionDao(), singletonCImpl.productDao(), singletonCImpl.saleDao(), singletonCImpl.lossDao(), singletonCImpl.provideApiServiceProvider.get());
            }
          };
          ...
          case 7: // com.kash.data.repository.DailyProfitRepositoryImpl 
          return (T) new DailyProfitRepositoryImpl(singletonCImpl.productTransactionDao());

          case 8: // com.kash.data.repository.ProductRepositoryImpl 
          return (T) new ProductRepositoryImpl(singletonCImpl.productDao(), singletonCImpl.saleDao(), singletonCImpl.lossDao());

          case 9: // com.kash.data.repository.InsightsRepositoryImpl 
          return (T) new InsightsRepositoryImpl(singletonCImpl.insightsDao());

          case 10: // com.kash.data.repository.TransactionRepositoryImpl 
